...
from models.FilterLayer import Mean_Norm
...
class ECAPA_TDNN(nn.Module):
    def __init__(self, num_classes=8, embedding_size=512, input_dim=40, input_norm='',
                 filter=None, sr=16000, feat_dim=256, exp=False, filter_fix=False,
                 dropout_p=0.0, dropout_layer=False, encoder_type='STAP',
