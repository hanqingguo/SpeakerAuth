...
from models.FilterLayer import Mean_Norm, TimeMaskLayer, FreqMaskLayer
from models.Pooling import StatisticPooling
from models.TDNN.TDNN import TimeDelayLayer_v2, TimeDelayLayer_v4, TimeDelayLayer_v5


class ETDNN(nn.Module):
    def __init__(self, num_classes, embedding_size=256, batch_norm=True, input_norm='Mean',
                 input_dim=40, dropout_p=0.0, dropout_layer=False, encoder_type='STAP', **kwargs):
